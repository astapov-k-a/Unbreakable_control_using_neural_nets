function [data mas whatclass classmas F J]=uc_integral_generatewave_main(minwlength,maxwlength,interval)
...
if sel<=0.25
    ...
    [whatclass, classmas, F, J]=uc_integral_crit(data,mas,0.05,0.1);
end
if (sel>0.25)&&(sel<=0.5);
    [data lb mas]=generate_wave2(13,14,minwlength,maxwlength,interval,0.9,1); %I 3.7%; II 92.2%; III 4.1%
    [whatclass, classmas, F, J]=uc_integral_crit(data,mas,0.1,0.1);
end
